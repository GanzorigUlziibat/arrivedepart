...
const App = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => {
    return (
      <Pressable
        style={styles.item}
        onPress={() => navigation.navigate("Report", { regdate: item.regdate })}
      >
  ...
  const renderHeader = () => {
    return (
      <View style={styles.item}>
        <View style={styles.item1}>
          <Text style={styles.itemDatetxt}>ОГНОО</Text>
        </View>
        <View style={styles.item2}>
          <Text style={styles.itemIrsentxt1}>ИРСЭН</Text>
        </View>
        <View style={styles.item3}>
          <Text style={styles.itemYavsantxt2}>ЯВСАН</Text>
        </View>
